...
obj = VideoReader('drowsy_5blk.mp4'); 
...
%% Use the first frame as a referance frame as open eyes and filter it 
% to detect the iris and its area 
...
%% Checking the eyes close or open position by detecting the IRIS and AREA of it.
    subplot(212)
 ...
 %% Comparing the area of the iris with the open conditon 0,4 - 0,3 - 0,2 open which is the inverse of close %   
...
%% Calculating the PERCLOSE ratios with the open eye condition 
